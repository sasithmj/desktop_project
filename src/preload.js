...
contextBridge.exposeInMainWorld("electronAPI", {
  ...
  checkDeviceExists: () => ipcRenderer.invoke("check-device-exists"),
  ...
  getNtpTime: () => ipcRenderer.invoke("get-ntp-time"),
  getCorrectedTime: () => ipcRenderer.invoke("get-corrected-time"),
